...
<form method="post" action="controller/update_backend.php" enctype="multipart/form-data">   
    ...
    <div class="row">
        ...
        <!-- <div class="p-3 py-5"> -->
                ...
                <div class="row mt-3">
                <div class="col-md-12"><label class="labels">Phone number</label><input type="number" name="a_phone" class="form-control" placeholder="Phone number" value="<?php echo $row['a_phone']; ?>"></div>
                    <div class="col-md-12"><label class="labels">Email</label><input type="email" name="a_email" class="form-control" value="<?php echo $row['a_email']; ?>" placeholder="Email"></div>
                    <div class="col-md-12"><label class="labels">Admin Password</label><input type="password" name="a_password" class="form-control" value="<?php echo $row['a_password']; ?>" placeholder="Password"></div>
